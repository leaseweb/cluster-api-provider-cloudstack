...
func (r *CloudStackAffinityGroup) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1beta2_CloudStackAffinityGroup_To_v1beta3_CloudStackAffinityGroup(r, dst, nil)
}

func (r *CloudStackAffinityGroup) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1beta3.CloudStackAffinityGroup)

	return Convert_v1beta3_CloudStackAffinityGroup_To_v1beta2_CloudStackAffinityGroup(src, r, nil)
}
